...
You can 1) draw tarot cards
        2) see your chakra
        3) see your zodiac sign and age
        4) see your favorite color's meaning (for fun ^-^)
        5) use Random Pick between three items
...
//PROGRAM STARTS HERE...
        ...
        public class ptc_main { //main class starts here
                ...
                for(int i = 0 ; i<100 ; i++) {  // for loop starts here
                    ...
                    if (user_string.equals("h")) {   //if condition for go home starts here
                        ...
                        switch (user_number) {
                            ...
                            default ->
                                    System.out.println("Something went wrong.Please enter a correct number.\nTry again.");
                        }
                        ...
                        System.out.println("\nI think you put the different character. Please try again.\n");
                    }
